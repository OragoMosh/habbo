...
import com.mmoscene.h4j.communication.composers.messenger.SendMessengerQueryResultsComposer;
import com.mmoscene.h4j.habbohotel.messenger.Friend;
import com.mmoscene.h4j.network.sessions.Session;
import org.magicwerk.brownies.collections.GapList;

public class SendMessengerSearchEvent implements GameEvent {
    @Override
    public void parse(Session session, Request request) {
        ...
        session.respond(SendMessengerQueryResultsComposer.compose(session.getHabbo().getMessenger().getFriends(), results));
    }
}
