...
import com.mmoscene.h4j.communication.composers.handshake.SendBannerMessageComposer;
import com.mmoscene.h4j.network.sessions.Session;

public class InitializeCryptologyEvent implements GameEvent {
    @Override
    public void parse(Session session, Request request) {
        session.respond(SendBannerMessageComposer.compose());
    }
}
